...
├── index.js # Entry point into the project which starts up the server and the slack bot
...
│   ├── slack-bot.js # Slack bot that uses botkit and Slack's RTM API and interacts with users on slack channel
...
│   ├── Briefing # Briefing Tab Component
│   ├── Search # Search Component
│   ├── Sentiment # Sentiment Component
│   ├── TopStories # TopStories Component
